...
void dfs(int v, Functor &&f, bool init = 1) {
...
//c1 denotes the previous color, c2 the new color to be flood filled
...
int floodfill(int r, int c, char c1, char c2) {
    ...
    for (auto direction: directions)
        ans += floodfill(r + direction.first, c + direction.second, c1, c2);
    return ans;
}
